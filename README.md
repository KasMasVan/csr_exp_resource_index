...
|6.3 | [Alpaca](https://huggingface.co/docs/transformers/main/en/model_doc/llama#transformers.LLaMAForCausalLM) |`tatsu-lab/alpaca-7b-wdiff` |   | Delta weights based on LLaMA. |
|6.4 | [Falcon](https://huggingface.co/docs/transformers/main/en/model_doc/llama#transformers.LLaMAForCausalLM) |`tiiuae/falcon-7b` <br> `tiiuae/falcon-7b-instruct` and two 40B variants |   | [Website](https://falconllm.tii.ae/) Requires Pytorch 2.0 |
