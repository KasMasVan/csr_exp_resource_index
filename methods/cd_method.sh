...
datasets="anli conceptual_combinations copa emoji_movie obqa piqa winogrande"
...
# weighting_parameters="-0.9102336340062064 -0.0842209396989961 -0.6363594017930332 -0.2074138221331238 -0.0331986456493744 -0.4214413430970229 -1.1042129476481897 -0.443686498100299 -0.2472216954079233 -1.795910378503944 -0.8517647890159739 -1.829911577260444"
expert_methods=("language_modeling" "calibration" "channel" "multiple_choice_prompt") # "language_modeling" "calibration" "channel" "multiple_choice_prompt"
amateur_methods=("language_modeling" "calibration" "channel" "multiple_choice_prompt") # best one for all expert methods
