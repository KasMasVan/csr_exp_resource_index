...
# seeds=(0 1 2 3 4)
seeds=(0)
model_family="Pythia" # "OPT-IML" "FLAN-T5" "Pythia" "FLAN-T5"
...
# datasets="logical_deduction_five_objects disambiguation_qa"
...
expert_method="calibration" # "language_modeling" "calibration" "channel" "multiple_choice_prompt"
amateur_method="language_modeling" 
